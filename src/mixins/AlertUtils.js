...
export const AlertUtils = {
    methods : {
        alertSuccess(message) {
            Swal.fire({
                position: 'top',
                // imageUrl: require('@/assets/images/icons/ic_copied_success.svg'),
                background: 'white',
                imageWidth: 18,
                imageHeight: 18,
                color: 'black',
                ...
                didOpen: () => {
                    ...
                    containerElement.style.setProperty('border', '2px solid black');
                }
            })
        },
        ...
        alertFailIcon(message) {
            Swal.fire({
                position: 'top',
                // imageUrl: require('@/assets/images/icons/modal_wrong_small.svg'),
                background: '#2d2d2d',
                imageWidth: 18,
                imageHeight: 18,
                color: 'white',
